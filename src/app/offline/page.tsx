...
export default function OfflinePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 flex items-center justify-center p-4 text-center relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(255,193,7,0.06),rgba(255,255,255,0))]" />
      
      <div className="w-full max-w-md bg-slate-900 border-3 border-black p-8 rounded-3xl space-y-6 z-10 shadow-[4px_4px_0px_#000000]">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-950 border-2 border-black text-slate-500 animate-pulse">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-405 leading-relaxed px-4">
